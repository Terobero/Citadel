...
public class Robot extends IterativeRobot {
	...
	public void robotInit() {
		...
		SmartDashboard.putString("Auto_text", "Autonomous Mode Chooser");
		SmartDashboard.putString("Sensor_text", "Sensor");
	...
	public void teleopPeriodic() {
		...
		//System.out.pr*sintln(ultra_left.getVoltage() + " " + ultra_right.getVoltage());
	}
	/*double s = 0.5;
